...
$sandbox = $host_split[0] == 'paypal' && $host_split[1] == 'angelleye' ? TRUE : FALSE;
...
$payflow_password = $sandbox ? 'S3cr3t!' : 'LIVE_PAYFLOW_PASSWORD';
 ...
 */
$finance_access_key = $sandbox ? 'f218a0faa71181e83a7fcb44a02b6915f0dfa0b9' : '';
$finance_client_secret = $sandbox ? 'a63b945a16745941dd3f119b3bfa3a55d161d09b' : '';
