...
class Angelleye_Cartflows_Pro_Helper {
    ...
    public function __construct() {
        add_filter('cartflows_offer_supported_payment_gateway_slugs', [$this, 'own_cartflows_offer_supported_payment_gateway_slugs'], 10, 1);
        add_filter('cartflows_offer_supported_payment_gateways', [$this, 'own_cartflows_offer_supported_payment_gateways'], 10, 1);
        add_action('wp_ajax_nopriv_cartflows_front_create_paypal_express_angelleye_checkout_token', [$this, 'generate_angelleye_express_checkout_token'], 10);
        add_action('wp_ajax_cartflows_front_create_paypal_express_angelleye_checkout_token', [$this, 'generate_angelleye_express_checkout_token'], 10);
        add_action('woocommerce_api_cartflows_paypal_express', [$this, 'maybe_handle_paypal_express_api_call']);
        add_filter('angelleye_ec_force_to_display_checkout_page', [$this, 'angelleye_express_checkout_cartflow']);
    ...
    public function own_cartflows_offer_supported_payment_gateways($supported_gateways) {
        $supported_gateways['paypal_express'] = [
        ...
        $supported_gateways['paypal_pro_payflow'] = [
