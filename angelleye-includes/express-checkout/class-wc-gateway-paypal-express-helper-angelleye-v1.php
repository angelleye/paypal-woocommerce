...
class Angelleye_PayPal_Express_Checkout_Helper {
        ...
        try {
            ...
            if ($this->enabled == 'yes') {
                ...
                if (!in_array('card', $this->disallowed_funding_methods)) {
                    $this->disallowed_card_types = !empty($this->setting['disallowed_card_types']) ? (array)$this->setting['disallowed_card_types'] : [];
                ...
                if ($this->single_product_configure_settings) {
                    ...
                    if (!in_array('card', $this->single_product_disallowed_funding_methods)) {
                        $this->disallowed_card_types = !empty($this->setting['disallowed_card_types']) ? $this->setting['disallowed_card_types'] : [];
                ...
                if ($this->is_paypal_credit_enable == true) {
                    $this->allowed_funding_methods = !empty($this->setting['allowed_funding_methods']) ? $this->setting['allowed_funding_methods'] : [
                ...
                add_action('wp_head', [$this, 'angelleye_add_header_meta'], 0);
                ...
                add_action('wp_enqueue_scripts', [$this, 'ec_enqueue_scripts_product_page'], 0);
                ...
                add_action('woocommerce_before_cart_table', [$this, 'top_cart_button']);
                ...
                add_action('wc_ajax_wc_angelleye_ppec_update_shipping_costs', [$this, 'wc_ajax_update_shipping_costs']);
                ...
                add_action('wp_enqueue_scripts', [$this, 'angelleye_paypal_marketing_solutions'], 10);
    ...
    public function ec_enqueue_scripts_product_page($is_mini_cart = false) {
		...
		'enable_in_context_checkout_flow' => $this->enable_in_context_checkout_flow == 'yes' ? 'yes' : 'no'
            ...
            if ($this->angelleye_is_in_context_enable() == true) {
                ...
                wp_register_script('angelleye-in-context-checkout-js', 'https://www.paypalobjects.com/api/checkout.min.js', ['jquery'], null, false);
                wp_register_script('angelleye-in-context-checkout-js-frontend', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/angelleye-in-context-checkout.min-v1.js', ['jquery', 'angelleye-in-context-checkout-js'], time(), true);
    ...
    public function frontend_scripts() {
        ...
        wp_register_script('angelleye_frontend', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/angelleye-frontend.js', ['jquery'], $this->version, true);
	...
	$translation_array = [];
        ...
        if (!is_admin() && is_cart()) {
            wp_enqueue_style('ppe_cart', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/css/cart.css', [], $this->version);
        }
	    
        if (!is_admin() && is_checkout()) {
            wp_enqueue_style('ppe_checkout', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/css/checkout.css', [], $this->version);
        }
        ...
        if (!is_admin() && $this->is_angelleye_product_page() && $this->setting['enabled'] == 'yes' && $this->setting['show_on_product_page'] == 'yes') {
            ...
            if ($_enable_ec_button == 'yes') {
                wp_enqueue_style('ppe_single', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/css/single.css', [], $this->version);
                wp_enqueue_script('angelleye_button');
            }
        }
    }
