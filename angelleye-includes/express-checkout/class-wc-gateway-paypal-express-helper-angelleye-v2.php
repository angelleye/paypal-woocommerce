...
class Angelleye_PayPal_Express_Checkout_Helper {
    ...
    public function __construct() {
        try {
            ...
            $this->setting = !empty($this->setting) ? $this->setting : [];
            ...
            if ($this->enabled == 'yes') {
                ...
                $this->paypal_flow_setting = !empty($this->paypal_flow_setting) ? $this->paypal_flow_setting : [];
                $this->paypal_pro_setting = AngellEYE_Utility::angelleye_get_pre_option(false, 'woocommerce_paypal_pro_settings');
                $this->paypal_pro_setting = isset($this->paypal_pro_setting) ? $this->paypal_pro_setting : [];
                ...
                // Globale setting
                $this->disallowed_funding_methods = !empty($this->setting['disallowed_funding_methods']) ? (array)$this->setting['disallowed_funding_methods'] : [];
                ...
                if ($this->single_product_configure_settings) {
                    ...
                    $this->single_product_disallowed_funding_methods = !empty($this->setting['single_product_disallowed_funding_methods']) ? $this->setting['single_product_disallowed_funding_methods'] : [];
                }
                ...
                if ($this->cart_configure_settings) {
                    ...
                    $this->cart_disallowed_funding_methods = !empty($this->setting['cart_disallowed_funding_methods']) ? $this->setting['cart_disallowed_funding_methods'] : [];
                }
                ...
                if ($this->mini_cart_configure_settings) {
                    ...
                    $this->mini_cart_disallowed_funding_methods = !empty($this->setting['mini_cart_disallowed_funding_methods']) ? $this->setting['mini_cart_disallowed_funding_methods'] : [];
                }
                ...
                if ($this->checkout_page_configure_settings) {
                    ...
                    $this->checkout_page_disallowed_funding_methods = !empty($this->setting['checkout_page_disallowed_funding_methods']) ? $this->setting['checkout_page_disallowed_funding_methods'] : [];
                }
                ...
                if ($this->wsc_cart_configure_settings) {
                    ...
                    $this->wsc_cart_disallowed_funding_methods = !empty($this->setting['wsc_cart_disallowed_funding_methods']) ? $this->setting['wsc_cart_disallowed_funding_methods'] : [];
                }
                ...
                $this->credit_messaging_page_type = !empty($this->setting['credit_messaging_page_type']) ? $this->setting['credit_messaging_page_type'] : ['home', 'category', 'product', 'cart', 'payment'];
                ...
                add_action('woocommerce_after_add_to_cart_button', [$this, 'buy_now_button'], 11);

                add_action('woocommerce_add_to_cart_redirect', [$this, 'add_to_cart_redirect'], 9999);
                add_action('woocommerce_checkout_billing', [$this, 'ec_set_checkout_post_data']);
                add_action('woocommerce_available_payment_gateways', [$this, 'ec_disable_gateways']);
                
                add_filter('body_class', [$this, 'ec_add_body_class']);
                
                add_action('woocommerce_checkout_fields', [$this, 'ec_display_checkout_fields']);
                add_action('woocommerce_before_checkout_billing_form', [$this, 'ec_formatted_billing_address'], 9);
                add_action('woocommerce_before_checkout_shipping_form', [$this, 'angelleye_shipping_sec_title'], 10);
                
                add_filter('woocommerce_terms_is_checked_default', [$this, 'ec_terms_express_checkout']);
                
                add_action('woocommerce_cart_emptied', [$this, 'ec_clear_session_data']);
                add_action('wp_enqueue_scripts', [$this, 'ec_enqueue_scripts'], 10);
                add_action('woocommerce_before_cart_table', [$this, 'top_cart_button'], 10);
                
                if ($this->enable_in_context_checkout_flow == 'no') {
                    if ($this->show_on_cart == 'yes' && $this->show_on_minicart == 'yes') {
                        add_action('woocommerce_after_mini_cart', [$this, 'mini_cart_button'], 20);
                    }
                } else {
                    if ($this->show_on_cart == 'yes' && $this->show_on_minicart == 'yes') {
                        add_action('woocommerce_widget_shopping_cart_buttons', [$this, 'mini_cart_button'], 20);
                    }
                }
                
                add_action('woocommerce_cart_contents', [$this, 'woocommerce_before_cart'], 12);
                
                add_filter('woocommerce_is_sold_individually', [$this, 'angelleye_woocommerce_is_sold_individually'], 10, 2);
                add_filter('woocommerce_ship_to_different_address_checked', [$this, 'angelleye_ship_to_different_address_checked'], 10, 1);
                add_filter('woocommerce_order_button_html', [$this, 'angelleye_woocommerce_order_button_html'], 10, 1);
                add_filter('woocommerce_coupons_enabled', [$this, 'angelleye_woocommerce_coupons_enabled'], 10, 1);
                
                add_action('woocommerce_cart_shipping_packages', [$this, 'maybe_add_shipping_information']);
                add_action('admin_notices', [$this, 'angelleye_billing_agreement_notice']);
                add_action('wc_ajax_wc_angelleye_ppec_update_shipping_costs', array($this, 'wc_ajax_update_shipping_costs'));
                
                add_filter('clean_url', [$this, 'angelleye_in_content_js']);
                
                add_action('wc_ajax_angelleye_ajax_generate_cart', [$this, 'angelleye_ajax_generate_cart']);
                
                if (AngellEYE_Utility::is_express_checkout_credentials_is_set()) {
                    if ($this->button_position == 'bottom' || $this->button_position == 'both') {
                        add_action('woocommerce_proceed_to_checkout', [$this, 'woocommerce_paypal_express_checkout_button_angelleye'], 22);
                    }
                }
                
                add_action('woocommerce_before_checkout_form', [$this, 'angelleye_display_custom_message_review_page'], 5);
                
                if ($this->enabled == 'yes' && ($this->show_on_checkout == 'top' || $this->show_on_checkout == 'both')) {
                    add_action('woocommerce_before_checkout_form', [$this, 'checkout_message'], 5);
                }
                ...
                add_filter('the_title', [$this, 'angelleye_paypal_for_woocommerce_page_title'], 99, 1);
                
                add_action('template_redirect', [$this, 'angelleye_redirect_to_checkout_page']);
                ...
                if ($this->checkout_page_disable_smart_button == false && $this->enable_in_context_checkout_flow == 'yes') {
                    add_action('woocommerce_review_order_after_submit', [$this, 'angelleye_display_paypal_button_checkout_page']);
                }
                
                $this->is_order_completed = true;
                
                add_filter('woocommerce_locate_template', [$this, 'angelleye_woocommerce_locate_template'], 10, 3);
                
                if ($this->wsc_cart_disable_smart_button == 'no') {
                    add_action('xoo_wsc_after_footer_btns', [$this, 'angelleye_xoo_cu_wsc_paypal_express'], 10);
                }
                
                add_action('widget_title', [$this, 'angelleye_maybe_enqueue_checkout_js'], 10, 3);
                add_action('woocommerce_before_checkout_process', [$this, 'angelleye_woocommerce_before_checkout_process'], 10);
                add_action('angelleye_fraudnet_hook', [$this, 'own_angelleye_fraudnet_hook'], 99, 1);
                add_action('wp_enqueue_scripts', [$this, 'own_angelleye_fraudnet_script'], 99, 1);
                
                add_filter( 'sgo_js_minify_exclude', [$this, 'angelleye_exclude_javascript'], 999);
                add_filter( 'sgo_javascript_combine_exclude', [$this, 'angelleye_exclude_javascript'], 999);
                add_filter( 'sgo_javascript_combine_excluded_inline_content', [$this, 'angelleye_exclude_javascript'], 999);
                add_filter( 'sgo_js_async_exclude', [$this, 'angelleye_exclude_javascript'], 999);
                
                if ($this->enabled_credit_messaging) {
                    if ($this->is_paypal_credit_messaging_enable_for_page($page = 'home') && $this->credit_messaging_home_shortcode === false) {
                        add_filter('the_content', [$this, 'angelleye_display_credit_messaging_home_page_content'], 10);
                        add_action('woocommerce_before_shop_loop', [$this, 'angelleye_display_credit_messaging_home_page'], 10, 99);
                    }
                    
                    if ($this->is_paypal_credit_messaging_enable_for_page($page = 'category') && $this->credit_messaging_category_shortcode === false) {
                        add_action('woocommerce_before_shop_loop', [$this, 'angelleye_display_credit_messaging_category_page'], 10, 99);
                    }
                    
                    if ($this->is_paypal_credit_messaging_enable_for_page($page = 'product') && $this->credit_messaging_product_shortcode === false) {
                        add_action('woocommerce_single_product_summary', [$this, 'angelleye_display_credit_messaging_product_page'], 11);
                    }
                    
                    if ($this->is_paypal_credit_messaging_enable_for_page($page = 'cart') && $this->credit_messaging_cart_shortcode === false) {
                        add_action('woocommerce_before_cart_table', [$this, 'angelleye_display_credit_messaging_cart_page'], 9);
                        add_filter('angelleye_bottom_cart_page', [$this, 'angelleye_display_credit_messaging_bottom_cart_page'], 10, 1);
                    }
                    
                    if ($this->is_paypal_credit_messaging_enable_for_page($page = 'payment') && $this->credit_messaging_payment_shortcode === false) {
                        add_action('woocommerce_before_checkout_form', [$this, 'angelleye_display_credit_messaging_payment_page'], 4);
                        if ($this->checkout_page_disable_smart_button == false && $this->enable_in_context_checkout_flow == 'yes') {
                            add_action('woocommerce_review_order_after_submit', [$this, 'angelleye_display_credit_messaging_payment_page'], 9);
                        }
                    }
                    
                    add_shortcode('aepfw_bnpl_message', [$this, 'aepfw_bnpl_message_shortcode'], 10);
                }
            }
        } catch (Exception $ex) {
    ...
    public function buy_now_button() {
        try {
            ...
            if ($this->enabled == 'yes' && $this->show_on_product_page == 'yes' && $is_ec_button_enable_product_level == 'yes') {
                ...
                $_allowed_product_type = apply_filters('angelleye_ec_product_type_allowed', ['variation', 'variable', 'simple']);
    ...
    public function ec_enqueue_scripts($is_mini_cart = false) {
        ...
        try {
            ...
            $js_value = [
                'is_page_name' => '', 
                'enable_in_context_checkout_flow' => $this->enable_in_context_checkout_flow == 'yes' ? 'yes' : 'no'
            ];
            ...
            if ($this->angelleye_is_in_context_enable() == true || $this->is_paypal_sdk_required()) {
                ...
                wp_register_script('angelleye-in-context-checkout-js', add_query_arg($smart_js_arg, 'https://www.paypal.com/sdk/js'), [], null, true);
                wp_register_script('angelleye-in-context-checkout-js-frontend', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/angelleye-in-context-checkout.min-v2.js', ['jquery', 'angelleye-in-context-checkout-js'], time(), true);
                ...
                wp_localize_script('angelleye-in-context-checkout-js-frontend', 'angelleye_in_content_param', [
                    ...
                    'start_flow'                                    => esc_url(add_query_arg(['startcheckout' => 'true', wc_get_cart_url()]),
                    ...
                    'get_express_checkout_details'                  => add_query_arg(['pp_action' => 'get_express_checkout_details', 'utm_nooverride' => 1, 'request_from' => 'JSv4'], untrailingslashit(WC()->api_request_url('WC_Gateway_PayPal_Express_AngellEYE'))),
            ...
            if (is_checkout()) {
                ...
                wp_enqueue_script('angelleye-express-checkout-js', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/angelleye-express-checkout.js', [], $this->version, true);
                wp_localize_script('angelleye-express-checkout-js', 'angelleye_js_value', $js_value);
            }
            
            wp_enqueue_style('angelleye-express-checkout-css', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/css/angelleye-express-checkout.css', [], $this->version, 'all');
        } catch (Exception $ex) {
    ...
    public function angelleye_paypal_for_woocommerce_page_title($page_title) {
        ...
        if (!is_admin() && is_main_query() && in_the_loop() && is_page() && is_checkout() && !empty($paypal_express_checkout)) {
            remove_filter('the_title', [$this, 'angelleye_paypal_for_woocommerce_page_title']);
    ...
    public function angelleye_is_product_already_in_cart($product_id = 0, $quantity = 1, $variation_id = 0, $variation = [], $cart_item_data = []) {
    ...
    public function angelleye_maybe_enqueue_checkout_js($widget_title, $widget_instance = [], $widget_id = null) {
    ...
    public function angelleye_display_credit_messaging_home_page_content($content) {
        ...
        if ((is_home() || is_front_page())) {
            wp_enqueue_script('angelleye-in-context-checkout-js');
            wp_enqueue_script('angelleye-credit-messaging-home', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/credit-messaging/home.js', ['jquery'], $this->version, true);
    ...
    public function angelleye_display_credit_messaging_category_page() {
        ...
        if (is_shop() === false && $this->credit_messaging_category_shortcode === false) {
            wp_enqueue_script('angelleye-in-context-checkout-js');
            wp_enqueue_script('angelleye-credit-messaging-category', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/credit-messaging/category.js', ['jquery'], $this->version, true);
    ...
    public function angelleye_display_credit_messaging_product_page() {
        ...
        wp_enqueue_script('angelleye-in-context-checkout-js');
        wp_enqueue_script('angelleye-credit-messaging-product', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/credit-messaging/product.js', ['jquery'], $this->version, true);
    ...
    public function angelleye_display_credit_messaging_cart_page() {
        ...
        wp_enqueue_script('angelleye-in-context-checkout-js');
        wp_enqueue_script('angelleye-credit-messaging-cart', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/credit-messaging/cart.js', ['jquery'], $this->version, true);
    ...
    public function angelleye_display_credit_messaging_payment_page() {
        ...
        wp_enqueue_script('angelleye-in-context-checkout-js');
        wp_enqueue_script('angelleye-credit-messaging-payment', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/credit-messaging/payment.js', ['jquery'], $this->version, true);
    ...
    public function aepfw_bnpl_message_shortcode($atts) {
        ...
        if (!in_array($atts['placement'], ['home', 'category', 'product', 'cart', 'payment'])) {
            return;
        }
        ...
        $atts = array_merge($default_array, (array)$atts);

        wp_enqueue_script('angelleye-in-context-checkout-js');
        wp_enqueue_script('angelleye-credit-messaging-shortcode', PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'assets/js/credit-messaging/shortcode.js', ['jquery'], $this->version, true);
    ...
    public function angelleye_credit_messaging_get_default_value($key, $placement) {
        if (!empty($key) && !empty($placement)) {
            ...
            $map_keys = [
                'placement'     => '', 
                'style'         => 'credit_messaging_default_layout_type', 
                'logotype'      => 'credit_messaging_default_text_layout_logo_type', 
                'logoposition'  => 'credit_messaging_default_text_layout_logo_position', 
                'textsize'      => 'credit_messaging_default_text_layout_text_size', 
                'textcolor'     => 'credit_messaging_default_text_layout_text_color', 
