jQuery(function ($) {
    ...
    function display_smart_button_on_cart_checkout() {
        window.paypalCheckoutReady = function () {
            ...
            angelleye_button_selector.push(".angelleye_smart_button_mini", ".angelleye_smart_button_checkout_bottom");
                ...
                if (selector.length > 0 && $(selector).length > 0) {
                    ...
                    paypal.Button.render({
                        ...
                        payment: function () {
                            ...
                            return paypal.request.post(angelleye_in_content_param.set_express_checkout + '&from_checkout=yes' , data_param).then(function (data) {
                                return data.token;
                            });
                        },
                        onAuthorize: function (data, actions) {
