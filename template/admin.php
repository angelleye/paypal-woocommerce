...
<div class="wrap">
    ...
    <?php if ($active_tab == 'general_settings') { ?>
        <h2 class="nav-tab-wrapper">
            <a href="?page=<?php echo $this->plugin_slug; ?>" class="nav-tab <?php echo $gateway == 'paypal_payment_gateway_products' ? 'nav-tab-active' : ''; ?>"><?php echo sprintf(__('%s', 'paypal-for-woocommerce'), AE_PPCP_NAME); ?></a>
