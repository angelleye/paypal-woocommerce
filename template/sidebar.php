    ...
    <div id="sidebar" class="angelleye-sidebar">
        ...
        <div class="angelleye-sidebar__section m10">
            ...
            <div class="angelleye-wizard-text-input">
                ...
                <input type="email" value="" id="angelleye_mailchimp_email" name="angelleye_mailchimp_email" class="email angelleye-wizard-text-input-field" placeholder="email address">
