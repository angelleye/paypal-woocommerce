...
* Fix - Resolves a duplicate note added to WooCommerce order when an Express Checkout order is refunded. ([#1057](https://github.com/angelleye/paypal-woocommerce/issues/1057))
