...
= 1.4.5.1 - 07.xx.2017 =
* Tweak - Adds custom class for calculating totals in all gateways to avoid conflicts with WC and PayPal calculations. ([#781](https://github.com/angelleye/paypal-woocommerce/issues/781)) ([#767](https://github.com/angelleye/paypal-woocommerce/issues/767))
