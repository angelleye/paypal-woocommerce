            ...
            if(is_admin()) {
                if( $this->subscription_support_enabled ) {
                    if ((isset($_GET['tab']) && 'checkout' === $_GET['tab']) && !isset($_GET['section'])) {
                        ...
                        include_once ( PAYPAL_FOR_WOOCOMMERCE_PLUGIN_DIR . '/ppcp-gateway/class-wc-gateway-pay-upon-invoice-angelleye.php');
                        ...
                        if (!isset($_GET['tab']) || $_GET['tab'] !== 'checkout') {
                            ...
                            $methods[] = 'WC_Gateway_Pay_Upon_Invoice_AngellEYE';
                        }
