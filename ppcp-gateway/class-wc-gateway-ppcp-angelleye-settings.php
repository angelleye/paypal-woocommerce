    ...
    class WC_Gateway_PPCP_AngellEYE_Settings {
        ...
        public function load() {
            ...
            $defaults = array('enabled' => 'no',
                ...
                'funnelkit_cart_button_size' => 'responsive',
                'funnelkit_cart_button_height' => '',
                'funnelkit_cart_button_label' => 'paypal',
                'funnelkit_cart_button_tagline' => 'no',
                'funnelkit_cart_button_width' => '',
                'funnelkit_cart_google_style_color' => 'default',
                'funnelkit_cart_google_button_type' => 'plain',
                'funnelkit_cart_google_button_height' => '',
                'funnelkit_cart_apple_style_color' => 'black',
                'funnelkit_cart_apple_button_type' => 'plain',
                'funnelkit_cart_apple_button_height' => '',
        ...
        public function angelleye_ppcp_setting_fields() {
            ...
            $this->woo_pre_order_payment_mode['authorize'] = __('Authorize / Capture', 'paypal-for-woocommerce');
            if ($this->is_paypal_vault_enable) {
                $this->woo_pre_order_payment_mode['vault'] = __('PayPal Vault (Recommended)', 'paypal-for-woocommerce');
            }
            ...
            $this->angelleye_ppcp_gateway_setting = array(
                ...
                'funnelkit_cart_button_settings' => array(
                    'title' => __('FunnelKit Sliding Cart Settings', 'paypal-for-woocommerce'),
                    'description' => __('Enable the FunnelKit Sliding Cart specific button settings, and the options set will be applied to the PayPal buttons inside the FunnelKit sliding cart.', 'paypal-for-woocommerce'),
                    'type' => 'title',
                    'class' => 'ppcp_separator_heading',
                ),
                'enable_funnelkit_cart_button' => array(
                    'title' => __('Enable/Disable', 'paypal-for-woocommerce'),
                    'class' => '',
                    'type' => 'checkbox',
                    'label' => __('Enable PayPal Smart Button on the FunnelKit Sliding Cart.', 'paypal-for-woocommerce'),
                    'default' => 'yes',
                    'desc_tip' => true,
                    'description' => __('', 'paypal-for-woocommerce'),
                ),
                'funnelkit_cart_disallowed_funding_methods' => array(
                    'title' => __('Hide Funding Method(s)', 'paypal-for-woocommerce'),
                    'type' => 'multiselect',
                ...
                'funnelkit_cart_button_layout' => array(
                    'title' => __('Button Layout', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Select Vertical for stacked buttons, and Horizontal for side-by-side buttons.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_style_color' => array(
                    'title' => __('Button Color', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the color you would like to use for the PayPal button.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_style_shape' => array(
                    'title' => __('Button Shape', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the shape you would like to use for the buttons.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_button_size' => array(
                    'title' => __('Button Size', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the size of the buttons you would like displayed. Responsive will fit to the current element on the page.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_button_height' => array(
                    'title' => __('Button Height', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the height of the buttons you would like displayed.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_button_label' => array(
                    'title' => __('Button Label', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the label type you would like to use for the PayPal button.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_button_tagline' => array(
                    'title' => __('Tagline', 'paypal-for-woocommerce'),
                    'type' => 'checkbox',
                    'class' => 'angelleye_ppcp_funnelkit_cart_button_settings',
                    'default' => 'no',
                    'label' => __('Enable tagline', 'paypal-for-woocommerce'),
                    'desc_tip' => true,
                    'description' => __('Add the tagline. This line will only show up if you select a horizontal layout.', 'paypal-for-woocommerce'),
                ),
                'funnelkit_cart_button_width' => array(
                    'title' => __('Buttons Width', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the width of the buttons (e.g. PayPal, Apple Pay, Google Pay) you would like displayed.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_google_style_color' => array(
                    'title' => __('Google Pay Button Color', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the color you would like to use for the Google Pay button.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_google_button_type' => array(
                    'title' => __('Google Pay Button Type', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the type you would like to use for the Google Pay button.', 'paypal-for-woocommerce'),
                    'desc_tip' => true,
                    'default' => 'plain',
                    'options' => array(
                        'plain' => __('Plain (Recommended)', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_google_button_height' => array(
                    'title' => __('Google Pay Button Height', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the height of the Google Pay button you would like displayed.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_apple_style_color' => array(
                    'title' => __('Apple Pay Button Color', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the color you would like to use for the Apple Pay button.', 'paypal-for-woocommerce'),
                ...
                'funnelkit_cart_apple_button_type' => array(
                    'title' => __('Apple Pay Button Type', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the type you would like to use for the Apple Pay button.', 'paypal-for-woocommerce'),
                    'desc_tip' => true,
                    'default' => 'plain',
                    'options' => $applePayBtnTypes,
                ),
                'funnelkit_cart_apple_button_height' => array(
                    'title' => __('Apple Pay Button Height', 'paypal-for-woocommerce'),
                    'type' => 'select',
                    'class' => 'wc-enhanced-select angelleye_ppcp_funnelkit_cart_button_settings',
                    'description' => __('Set the height of the Apple Pay button you would like displayed.', 'paypal-for-woocommerce'),
            ...
            // Hide FunnelKit Sliding Cart settings when FunnelKit Cart for WooCommerce is not installed
            if (!class_exists('\FKCart\Plugin')) {
                $funnelkit_cart_keys = array(
                    'funnelkit_cart_button_settings',
                    'enable_funnelkit_cart_button',
                    'funnelkit_cart_disallowed_funding_methods',
                    'funnelkit_cart_button_layout',
                    'funnelkit_cart_style_color',
                    'funnelkit_cart_style_shape',
                    'funnelkit_cart_button_size',
                    'funnelkit_cart_button_height',
                    'funnelkit_cart_button_label',
                    'funnelkit_cart_button_tagline',
                    'funnelkit_cart_button_width',
                    'funnelkit_cart_google_style_color',
                    'funnelkit_cart_google_button_type',
                    'funnelkit_cart_google_button_height',
                    'funnelkit_cart_apple_style_color',
                    'funnelkit_cart_apple_button_type',
                    'funnelkit_cart_apple_button_height',
                );
                foreach ($funnelkit_cart_keys as $fkc_key) {
                    unset($this->angelleye_ppcp_gateway_setting[$fkc_key]);
                }
            }
