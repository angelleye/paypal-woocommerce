class PayPalFastlane {
    ...
    async renderCardDetails() {
        ...
        if (this.profileData?.card) {
            ...
            console.log("Injected HTML:", jQuery(this.containerSelector).html());
    ...
    bindWooCommerceEvents() {
        jQuery(document.body).off('updated_checkout ppcp_fastlane_checkout_updated'); // Unbind existing listeners
