...
jQuery(function ($) {
    ...
    var ppcp_available = $('#woocommerce_angelleye_ppcp_enable_advanced_card_payments, #woocommerce_angelleye_ppcp_3d_secure_contingency, #woocommerce_angelleye_ppcp_advanced_card_payments_display_position, #woocommerce_angelleye_ppcp_disable_cards').closest('tr');
    ...
    $('#woocommerce_angelleye_ppcp_enable_advanced_card_payments').change(function () {
        if ($(this).is(':checked')) {
            ...
            $('#woocommerce_angelleye_ppcp_advanced_card_payments_title').closest('tr').show();
        } else {
            if ($("#woocommerce_angelleye_ppcp_checkout_disallowed_funding_methods option[value='card']").length === 0) {
            ...
            $('#woocommerce_angelleye_ppcp_3d_secure_contingency, #woocommerce_angelleye_ppcp_advanced_card_payments_title, #woocommerce_angelleye_ppcp_advanced_card_payments_display_position').closest('tr').hide();
        }
    }).change();
