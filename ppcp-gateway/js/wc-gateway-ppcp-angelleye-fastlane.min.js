class PayPalFastlane{constructor(e){this.containerSelector=e,this.fastlaneInstance=null,this.profileData=null,this.paymentToken=null,this.savedCardHtml="",this.paymentMethodId="angelleye_ppcp_fastlane",this.isCardDetailsRestored=!1,this.isPaymentMethodSet=!1,this.fastlaneCardComponent=null}async initialize(){try{this.fastlaneInstance=await angelleye_paypal_sdk.Fastlane({}),this.fastlaneInstance.setLocale("en_us"),this.bindEmailLookupEvent(),this.bindWooCommerceEvents()}catch(e){console.error("Failed to initialize Fastlane:",e)}}async lookupCustomerByEmail(e){try{let{customerContextId:t}=await this.fastlaneInstance.identity.lookupCustomerByEmail(e);return t}catch(a){return console.error("Error looking up customer by email:",a),null}}async authenticateCustomer(e){try{console.log("38");let{authenticationState:t,profileData:a}=await this.fastlaneInstance.identity.triggerAuthenticationFlow(e);return"succeeded"===t&&(this.profileData=a,this.paymentToken=a.card?.id||null,this.updateWooCheckoutFields(a)),"succeeded"===t}catch(i){return console.error("Error authenticating customer:",i),!1}}async renderCardDetails(){this.profileData?.card?(this.savedCardHtml=`
