...
class WC_Gateway_PPCP_AngellEYE extends WC_Payment_Gateway_CC {
    ...
    public function setup_properties() {
        ...
        $this->method_title = apply_filters('angelleye_ppcp_gateway_method_title', __('Complete Payments - Powered by PayPal method_title', 'paypal-for-woocommerce'));
    ...
    public function payment_fields() {
        ...
        if ((is_checkout() || is_checkout_pay_page()) && $this->enable_separate_payment_method === false && $this->advanced_card_payments === true) {
