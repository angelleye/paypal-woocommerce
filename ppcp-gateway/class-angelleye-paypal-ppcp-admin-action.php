        ...
        try {
            ...
            $notice_data['classic_upgrade'] = array(
                ...
                'ans_message_description' => sprintf('Your current PayPal integration is outdated and could lead to missed features, higher fees, and potential security risks. PayPal Complete Payments offers:<br>
                    ...
                    <b>Action Required:</b> Upgrade now to keep your PayPal integration secure, cost-effective, and fully supported. <a target="_blank" href="%s">Click here to start your upgrade</a>—it only takes a few minutes!',
