            ...
            switch ($_GET['angelleye_ppcp_action']) {
                ...
                case "handle_js_errors":
                    ...
                    if( isset($_POST['error']['msg']) && isset($_POST['error']['source']) && isset($_POST['error']['line']) ){
                        ...
                        wc_get_logger()->info( 'JavaScript Error: ' . html_entity_decode( $_POST['error']['error'], ENT_QUOTES ) . ', apiUrl: ' . $_POST['error']['apiUrl'] . ', apiStatus:' . $_POST['error']['status'], array( 'source' => 'angelleye_ppcp_js_errors' ) );
                    }
                    break;
                case "cc_capture":
                    wc_clear_notices();
