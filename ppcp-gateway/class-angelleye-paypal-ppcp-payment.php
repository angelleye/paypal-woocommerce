    ...
    public function angelleye_ppcp_get_checkout_details($paypal_order_id) {
        try {
            $args = array(
                ...
                'httpversion' => '1.1',
                'blocking' => true,
                'headers' => array('Content-Type' => 'application/json', 'Authorization' => '', "prefer" => "return=representation"),
                'body' => array(),
                'cookies' => array()
            );
    ...
    public function angelleye_ppcp_order_capture_request($woo_order_id, $need_to_update_order = true) {
        try {
            ...
            $args = array(
                ...
                'httpversion' => '1.1',
                'blocking' => true,
                'headers' => array('Content-Type' => 'application/json', '', "prefer" => "return=representation", 'PayPal-Request-Id' => $this->generate_request_id()),
            );
