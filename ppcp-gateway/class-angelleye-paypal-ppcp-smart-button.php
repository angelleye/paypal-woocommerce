...
class AngellEYE_PayPal_PPCP_Smart_Button {
    ...
    public function enqueue_scripts() {
        ...
        wp_register_script($this->angelleye_ppcp_plugin_name, PAYPAL_FOR_WOOCOMMERCE_ASSET_URL . 'ppcp-gateway/js/wc-gateway-ppcp-angelleye-public' . $this->minified_version . '.js', array('angelleye-paypal-checkout-sdk', 'angelleye_ppcp-common-functions'), $script_versions, false);
    ...
    public function display_paypal_button_cart_page($is_shortcode = "") {
        ...
        if (WC()->cart->needs_payment()) {
            ...
            if ($is_shortcode === 'yes') {
                ...
                echo '<div class="angelleye_ppcp-button-container angelleye_ppcp_' . $this->style_layout . '_' . $this->style_size . '"><div id="angelleye_ppcp_cart"></div><div id="angelleye_ppcp_cart_apple_pay"></div><div class="angelleye_ppcp-proceed-to-checkout-button-separator">&mdash; ' . __('OR', 'paypal-for-woocommerce') . ' &mdash;</div></div>';
            }
        }
    }
